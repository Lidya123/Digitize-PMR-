    ...
    return (
        <div>
            <div className='text-center'>
                <h3 className='text-secondary'>Access to write prescription</h3>
                    ...
                    <div className='text-right'>
                        ...
                        <h5>Enter Patient Credentials</h5>
                            ...
                            <div className="inputs">
                                ...
                                <input type="text" className='rounded' /><br/>                              
                                <button onClick={navigateToWrite} className='btn btn-outline-dark rounded-pill pl-4 pr-4 mt-4' type="submit">Verify</button>
                            </div>
                                </div>
                            </div>
                        </div>
